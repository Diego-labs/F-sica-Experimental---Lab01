...
# pega os dados
dados1 = np.loadtxt('ensaio1_M5.txt', skiprows=1)
tempo1 = dados1[:, 2]
posicao1 = dados1[:, 0] / 100

dados2 = np.loadtxt('ensaio1_M10.txt', skiprows=1)
tempo2 = dados2[:, 2]
posicao2 = dados2[:, 0] / 100

dados3 = np.loadtxt('ensaio1_M15.txt', skiprows=1)
tempo3 = dados3[:, 2]
posicao3 = dados3[:, 0] / 100

dados4 = np.loadtxt('ensaio1_M20.txt', skiprows=1)
tempo4 = dados4[:, 2]
posicao4 = dados4[:, 0] / 100

dados5 = np.loadtxt('ensaio1_M25.txt', skiprows=1)
tempo5 = dados5[:, 2]
posicao5 = dados5[:, 0] / 100

dados6 = np.loadtxt('ensaio1_M30.txt', skiprows=1)
tempo6 = dados6[:, 2]
...
ajustar_e_plotar(tempo1, posicao1, 'Mt = 228,61 g', 'o', cores[0])
ajustar_e_plotar(tempo2, posicao2, 'Mt = 233,82 g', 's', cores[1])
ajustar_e_plotar(tempo3, posicao3, 'Mt = 239,14 g', '^', cores[2])
ajustar_e_plotar(tempo4, posicao4, 'Mt = 244,41 g', 'D', cores[3])
ajustar_e_plotar(tempo5, posicao5, 'Mt = 249,51 g', 'x', cores[4])
ajustar_e_plotar(tempo6, posicao6, 'Mt = 254,74 g', '*', cores[5])
